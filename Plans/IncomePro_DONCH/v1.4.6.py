...
def setGlobalVars():
	global long_trigger, short_trigger, c_direction
...
def handleStopAndReverse(entry):
	...
	if bank:
		tp = VARIABLES['tprange'] if entry.entry_type == EntryType.ADDITIONAL else VARIABLES['firsttprange']
...
def runSequence():
	...
	if time_state != TimeState.STOP:
		...
		if c_direction != Direction.SHORT:
